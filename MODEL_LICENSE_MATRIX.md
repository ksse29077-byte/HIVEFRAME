...
|---|---|---|---|---|
| MiniMax H3 official API | Primary product backend target; black-box candidate | Official V2 docs reviewed 2026-07-31 name `MiniMax-H3` at `POST /v2/video_generation`; no runtime call was made | Pending separate API admission; not implemented or supported | Pin documentation and terms snapshots; verify price/billing, queue/generation/download timing, retention/deletion/training use, commercial conditions, provenance, errors/retries, safety states, and receipt semantics; Issue #39 |
| MiniMax H3 open weights | Future white-box target | No official source repository, checkpoint, weight license, digest, and admitted runtime were jointly verified on 2026-07-31 | Blocked until weights and license are verified | Official repository and checkpoint; source and weight licenses; immutable digests; runtime/hardware; redistribution and commercial terms; do not treat an announced plan as a released artifact |
| Wan 2.1 official code | Frozen legacy comparator; M0 runtime reference | Apache-2.0 in the pinned GitHub source tree | Verified for historical research baseline; new feature development inactive | Code revision `9737cba9c1c3c4d04b33fcad41c111989865d315`; commercial use and modification allowed; redistribution must carry the license, modification notices, applicable attributions, and NOTICE if one is later present; no NOTICE file observed at this revision |
| Wan 2.1 T2V 1.3B checkpoint | Frozen legacy comparator; M0 weights | Apache-2.0 in the separate official Hugging Face checkpoint repository | Verified for immutable historical evidence; new feature development inactive | Checkpoint revision `37ec512624d61f7aa208f7ea8140a131f93afc9a`; exact large-file sizes/SHA-256 pinned; commercial use, modification, and redistribution follow Apache-2.0; separate model-card use conditions are recorded; no NOTICE file observed at this revision |
...
| LTX-2 | Historical control and audio-video research candidate | Existing historical repository and adapter references are preserved | Inactive; removed from active development scope | No new integration or model use; any cleanup or reactivation requires separate approval and renewed license review |
